    ...
    var notas = [5,5,10,5,5,10,10,10,10,10,10,10];
    var grave12;
    var grave13;
    var grave14;
   ...
   function resNao(id){
      ...
      if(resposta == "nao"){
        ...
        switch (pergunta) {
            ...
            case "ofensor11":
                ...
                break;
            case "ofensor15":
                if(notaSubtraida.ofensor15 == "n"){
                    notas[11] =0;
                    notaSubtraida.ofensor15 = "s";
                }                
                break;    
        }
        nota = 0;
    ...
    function resSim(id){
      ...
      if(resposta != "nao"){
        ...
        console.log(notas);
        console.log("Ta aqui"+nota);
        console.log(notaSubtraida)    
    ...
    function voltaNota(id){
        ...
        switch (id) {
            ...
            case "11-s":
                ...
                break;
            case "15-s":
                if(notaSubtraida.ofensor15 == "s"){
                    notas[11] =10;
                    notaSubtraida.ofensor15 = "n";
                }                
                break;
