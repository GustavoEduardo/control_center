        ...
        switch (id) {
            case "1-s":
                if(notaSubtraida.ofensor1 == "s"){
                    ...
                    document.getElementById("ofensor1").innerHTML = "";   
                }     
                break;
            case "3-s":
                if(notaSubtraida.ofensor3 == "s"){
                    ...
                    document.getElementById("ofensor3").innerHTML = "";   
                }               
                break;
            case "4-s":
                if(notaSubtraida.ofensor4 == "s"){
                    ...
                    document.getElementById("ofensor4").innerHTML = "";   
                }                
                break;
            case "2-s":
                if(notaSubtraida.ofensor2 == "s"){
                    ...
                    document.getElementById("ofensor2").innerHTML = "";   
                }                
                break;
            case "5-s":
                if(notaSubtraida.ofensor5 == "s"){
                    ...
                    document.getElementById("ofensor5").innerHTML = "";   
                }                
                break;
            case "6-n":
                if(notaSubtraida.ofensor6 == "s"){
                    ...
                    document.getElementById("ofensor6").innerHTML = "";   
                }                
                break;
            case "7-s":
                if(notaSubtraida.ofensor7 == "s"){
                    ...
                    document.getElementById("ofensor7").innerHTML = "";   
                }                
                break;
            case "8-s":
                if(notaSubtraida.ofensor8 == "s"){
                    ...
                    document.getElementById("ofensor8").innerHTML = "";   
                }                
                break; 
            case "9-s":
                if(notaSubtraida.ofensor9 == "s"){
                    ...
                    document.getElementById("ofensor9").innerHTML = "";   
                }                
                break; 
            case "10-s":
                if(notaSubtraida.ofensor10 == "s"){
                    ...
                    document.getElementById("ofensor10").innerHTML = "";   
                }                
                break; 
            case "11-s":
                if(notaSubtraida.ofensor11 == "s"){
                    ...
                    document.getElementById("ofensor11").innerHTML = "";   
                }                
                break;
            ...
            case "12-s":
                if(notaSubtraida.ofensor12 == "s"){
                    ...
                    document.getElementById("ofensor12").innerHTML = "";   
                }                
                break; 
            case "13-n":
                if(notaSubtraida.ofensor13 == "s"){
                    ...
                    document.getElementById("ofensor13").innerHTML = "";   
                }                
                break;               
            case "14-n":
                if(notaSubtraida.ofensor14 == "s"){
                    ...
                    document.getElementById("ofensor14").innerHTML = "";   
                }                
                break;
